...
export const mockPatients: Patient[] = [
  ...
  },
  {
    ...
    gender: 'male',
    phoneNumber: '+974501234567',
    email: 'mohammed.kuwari@email.com',
    insuranceId: 'GOV-QA-9012',
...
export const countryInfo = {
  SA: { name: 'Saudi Arabia', nameAr: 'السعودية', currency: 'SAR', flag: '🇸🇦' },
  UAE: { name: 'United Arab Emirates', nameAr: 'الإمارات', currency: 'AED', flag: '🇦🇪' },
  QA: { name: 'Qatar', nameAr: 'قطر', currency: 'QAR', flag: '🇶🇦' },
  KW: { name: 'Kuwait', nameAr: 'الكويت', currency: 'KWD', flag: '🇰🇼' },
  BH: { name: 'Bahrain', nameAr: 'البحرين', currency: 'BHD', flag: '🇧🇭' },
  OM: { name: 'Oman', nameAr: 'عمان', currency: 'OMR', flag: '🇴🇲' }
};
